...
MODULE Constants_Conversion
  ...
  REAL(SRK),PARAMETER :: HALFPI=1.570796326794897_SRK !16 digits
  REAL(SRK),PARAMETER ::     PI=3.141592653589793_SRK !16 digits
  REAL(SRK),PARAMETER ::  TWOPI=6.283185307179586_SRK !16 digits
  REAL(SRK),PARAMETER :: FOURPI=12.56637061435917_SRK !16 digits
  !> Avogadro's Number
