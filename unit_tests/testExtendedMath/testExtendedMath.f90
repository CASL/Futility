...
!-------------------------------------------------------------------------------
    SUBROUTINE testGammaF()
      ...
      ASSERT(GAMMAF(0.25_SRK) .APPROXEQ. 3.6256099082219083119_SRK, 'GammaF 0.25')
      ASSERT(GAMMAF(0.5_SRK) .APPROXEQ. 1.7724538509055160273_SRK, 'GammaF 0.5')
      ASSERT(GAMMAF(0.75_SRK) .APPROXEQ. 1.2254167024651776451_SRK, 'GammaF 0.75')
      ASSERT(GAMMAF(3.5_SRK) .APPROXEQ. 3.3233509704478425512_SRK, 'GammaF 3.5')
      ASSERT(GAMMAF(5.00_SRK) .APPROXEQ. 24.00000000000000000_SRK, 'GammaF 5.0')
      ASSERT(GAMMAF(7.00_SRK) .APPROXEQ. 720.00000000000000000_SRK, 'GammaF 7.0')
