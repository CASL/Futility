...
!
      ...
      ASSERT(findLowBound(tmprealarray,3.0_SRK,.FALSE.) .APPROXEQA. 2.0_SRK,'Lower Bound == 2.0')
      ASSERT(findLowBound(tmprealarray,8.0_SRK,.FALSE.) .APPROXEQA. 6.0_SRK,'Lower Bound == 6.0')
      ASSERT(findLowBound(tmprealarray,12.0_SRK,.FALSE.) .APPROXEQA. 10.0_SRK,'Lower Bound == 10.0')
      ASSERT(findLowBound(tmprealarray,18.0_SRK,.FALSE.) .APPROXEQA. 15.0_SRK,'Lower Bound == 15.0')
      ASSERT(findLowBound(tmprealarray,30.0_SRK,.FALSE.) .APPROXEQ. 20.0_SRK,'Lower Bound == 20.0')
      ...
      tmprealarray(9)=20.0_SRK !60.0
      tmprealarray(10)=5.0_SRK  !65.0
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),-11.0_SRK,.TRUE.) .APPROXEQA. 0.0_SRK
      ASSERT(bool,'Out of Lower Bounds')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),101.0_SRK,.TRUE.) .APPROXEQA. 0.0_SRK
      ASSERT(bool,'Out of Upper Bounds')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),-1.0_SRK,.TRUE.) .APPROXEQA. -10.0_SRK
      ASSERT(bool,'Lower Bound == -10.0')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),1.0_SRK,.TRUE.) .APPROXEQA. 0.0_SRK
      ASSERT(bool,'Lower Bound == 0.0')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),3.0_SRK,.TRUE.) .APPROXEQA. 2.0_SRK
      ASSERT(bool,'Lower Bound == 2.0')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),8.0_SRK,.TRUE.) .APPROXEQA. 6.0_SRK
      ASSERT(bool,'Lower Bound == 6.0')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),12.0_SRK,.TRUE.) .APPROXEQA. 10.0_SRK
      ASSERT(bool,'Lower Bound == 10.0')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),18.0_SRK,.TRUE.) .APPROXEQA. 15.0_SRK
      ASSERT(bool,'Lower Bound == 15.0')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),30.0_SRK,.TRUE.) .APPROXEQA. 20.0_SRK
      ASSERT(bool,'Lower Bound == 20.0')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),50.0_SRK,.TRUE.) .APPROXEQA. 40.0_SRK
      ASSERT(bool,'Lower Bound == 40.0')
      bool=findLowBound((/-10.0_SRK,tmprealarray(2:10)/),62.0_SRK,.TRUE.) .APPROXEQA. 60.0_SRK
...
!
      ...
      ASSERT(findUpBound(tmprealarray,3.0_SRK,.FALSE.) .APPROXEQ. 6.0_SRK,'Upper Bound == 6.0')
      ASSERT(findUpBound(tmprealarray,8.0_SRK,.FALSE.) .APPROXEQ. 10.0_SRK,'Upper Bound == 10.0')
      ASSERT(findUpBound(tmprealarray,12.0_SRK,.FALSE.) .APPROXEQ. 15.0_SRK,'Upper Bound == 15.0')
      ASSERT(findUpBound(tmprealarray,18.0_SRK,.FALSE.) .APPROXEQ. 20.0_SRK,'Upper Bound == 20.0')
      ASSERT(findUpBound(tmprealarray,30.0_SRK,.FALSE.) .APPROXEQ. 40.0_SRK,'Upper Bound == 40.0')
      ...
      ASSERT(findUpBound((/0.0_SRK,tmprealarray/),3.0_SRK,.FALSE.) .APPROXEQ. 6.0_SRK,'Upper Bound == 6.0')
      ASSERT(findUpBound((/0.0_SRK,tmprealarray/),8.0_SRK,.FALSE.) .APPROXEQ. 10.0_SRK,'Upper Bound == 10.0')
      ASSERT(findUpBound((/0.0_SRK,tmprealarray/),12.0_SRK,.FALSE.) .APPROXEQ. 15.0_SRK,'Upper Bound == 15.0')
      ASSERT(findUpBound((/0.0_SRK,tmprealarray/),18.0_SRK,.FALSE.) .APPROXEQ. 20.0_SRK,'Upper Bound == 20.0')
      ASSERT(findUpBound((/0.0_SRK,tmprealarray/),30.0_SRK,.FALSE.) .APPROXEQ. 40.0_SRK,'Upper Bound == 40.0')
      ASSERT(findUpBound((/0.0_SRK,tmprealarray/),50.0_SRK,.FALSE.) .APPROXEQ. 60.0_SRK,'Upper Bound == 60.0')
      ...
      tmprealarray(9)=20.0_SRK !60.0
      tmprealarray(10)=5.0_SRK  !65.0
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),-11.0_SRK,.TRUE.) .APPROXEQA. 0.0_SRK
      ASSERT(bool,'Out of Lower Bounds')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),101.0_SRK,.TRUE.) .APPROXEQA. 0.0_SRK
      ASSERT(bool,'Out of Upper Bounds')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),-1.0_SRK,.TRUE.) .APPROXEQA. 0.0_SRK
      ASSERT(bool,'Lower Bound == 0.0')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),1.0_SRK,.TRUE.) .APPROXEQA. 2.0_SRK
      ASSERT(bool,'Lower Bound == 2.0')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),3.0_SRK,.TRUE.) .APPROXEQA. 6.0_SRK
      ASSERT(bool,'Lower Bound == 6.0')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),8.0_SRK,.TRUE.) .APPROXEQA. 10.0_SRK
      ASSERT(bool,'Lower Bound == 10.0')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),12.0_SRK,.TRUE.) .APPROXEQA. 15.0_SRK
      ASSERT(bool,'Lower Bound == 15.0')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),18.0_SRK,.TRUE.) .APPROXEQA. 20.0_SRK
      ASSERT(bool,'Lower Bound == 20.0')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),30.0_SRK,.TRUE.) .APPROXEQA. 40.0_SRK
      ASSERT(bool,'Lower Bound == 40.0')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),50.0_SRK,.TRUE.) .APPROXEQA. 60.0_SRK
      ASSERT(bool,'Lower Bound == 60.0')
      bool=findUpBound((/-10.0_SRK,tmprealarray(2:10)/),62.0_SRK,.TRUE.) .APPROXEQA. 65.0_SRK
...
!
      ...
      ASSERT(findEleHtAbove(tmprealarray,3.0_SRK,.FALSE.) .APPROXEQ. 3.0_SRK,'EleHtAbove == 3.0')
      ASSERT(findEleHtAbove(tmprealarray,8.0_SRK,.FALSE.) .APPROXEQ. 2.0_SRK,'EleHtAbove == 2.0')
      ASSERT(findEleHtAbove(tmprealarray,12.0_SRK,.FALSE.) .APPROXEQ. 3.0_SRK,'EleHtAbove == 3.0')
      ASSERT(findEleHtAbove(tmprealarray,18.0_SRK,.FALSE.) .APPROXEQ. 2.0_SRK,'EleHtAbove == 2.0')
      ...
      ASSERT(findEleHtAbove((/0.0_SRK,tmprealarray/),3.0_SRK,.FALSE.) .APPROXEQ. 3.0_SRK,'EleHtAbove == 3.0')
      ASSERT(findEleHtAbove((/0.0_SRK,tmprealarray/),8.0_SRK,.FALSE.) .APPROXEQ. 2.0_SRK,'EleHtAbove == 2.0')
      ASSERT(findEleHtAbove((/0.0_SRK,tmprealarray/),12.0_SRK,.FALSE.) .APPROXEQ. 3.0_SRK,'EleHtAbove == 3.0')
      ASSERT(findEleHtAbove((/0.0_SRK,tmprealarray/),18.0_SRK,.FALSE.) .APPROXEQ. 2.0_SRK,'EleHtAbove == 2.0')
      ASSERT(findEleHtAbove((/0.0_SRK,tmprealarray/),30.0_SRK,.FALSE.) .APPROXEQ. 10.0_SRK,'EleHtAbove == 10.0')
      ASSERT(findEleHtAbove((/0.0_SRK,tmprealarray/),50.0_SRK,.FALSE.) .APPROXEQ. 10.0_SRK,'EleHtAbove == 10.0')
      ASSERT(findEleHtAbove((/0.0_SRK,tmprealarray/),62.0_SRK,.FALSE.) .APPROXEQ. 3.0_SRK,'EleHtAbove == 3.0')
      ...
      tmprealarray(9)=20.0_SRK !60.0
      tmprealarray(10)=5.0_SRK  !65.0
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),-11.0_SRK,.TRUE.) .APPROXEQA. 11.0_SRK
      ASSERT(bool,'Out of Lower Bounds')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),101.0_SRK,.TRUE.) .APPROXEQA. -101.0_SRK
      ASSERT(bool,'Out of Upper Bounds')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),-1.0_SRK,.TRUE.) .APPROXEQA. 1.0_SRK
      ASSERT(bool,'Lower Bound == 1.0')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),1.0_SRK,.TRUE.) .APPROXEQA. 1.0_SRK
      ASSERT(bool,'Lower Bound == 1.0')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),3.0_SRK,.TRUE.) .APPROXEQA. 3.0_SRK
      ASSERT(bool,'Lower Bound == 3.0')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),8.0_SRK,.TRUE.) .APPROXEQA. 2.0_SRK
      ASSERT(bool,'Lower Bound == 2.0')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),12.0_SRK,.TRUE.) .APPROXEQA. 3.0_SRK
      ASSERT(bool,'Lower Bound == 3.0')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),18.0_SRK,.TRUE.) .APPROXEQA. 2.0_SRK
      ASSERT(bool,'Lower Bound == 2.0')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),30.0_SRK,.TRUE.) .APPROXEQA. 10.0_SRK
      ASSERT(bool,'Lower Bound == 10.0')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),50.0_SRK,.TRUE.) .APPROXEQA. 10.0_SRK
      ASSERT(bool,'Lower Bound == 10.0')
      bool=findEleHtAbove((/-10.0_SRK,tmprealarray(2:10)/),62.0_SRK,.TRUE.) .APPROXEQA. 3.0_SRK
      ASSERT(bool,'Lower Bound == 3.0')
!
!
      ...
      ASSERT(findEleHtBelow(tmprealarray,3.0_SRK,.FALSE.) .APPROXEQ. 1.0_SRK,'EleHtBelow == 1.0')
      ASSERT(findEleHtBelow(tmprealarray,8.0_SRK,.FALSE.) .APPROXEQ. 2.0_SRK,'EleHtBelow == 2.0')
      ASSERT(findEleHtBelow(tmprealarray,12.0_SRK,.FALSE.) .APPROXEQ. 2.0_SRK,'EleHtBelow == 2.0')
      ASSERT(findEleHtBelow(tmprealarray,18.0_SRK,.FALSE.) .APPROXEQ. 3.0_SRK,'EleHtBelow == 3.0')
      ...
      ASSERT(findEleHtBelow((/0.0_SRK,tmprealarray/),3.0_SRK,.FALSE.) .APPROXEQ. 1.0_SRK,'EleHtBelow == 1.0')
      ASSERT(findEleHtBelow((/0.0_SRK,tmprealarray/),8.0_SRK,.FALSE.) .APPROXEQ. 2.0_SRK,'EleHtBelow == 2.0')
      ASSERT(findEleHtBelow((/0.0_SRK,tmprealarray/),12.0_SRK,.FALSE.) .APPROXEQ. 2.0_SRK,'EleHtBelow == 2.0')
      ASSERT(findEleHtBelow((/0.0_SRK,tmprealarray/),18.0_SRK,.FALSE.) .APPROXEQ. 3.0_SRK,'EleHtBelow == 3.0')
      ASSERT(findEleHtBelow((/0.0_SRK,tmprealarray/),30.0_SRK,.FALSE.) .APPROXEQ. 10.0_SRK,'EleHtBelow == 10.0')
      ASSERT(findEleHtBelow((/0.0_SRK,tmprealarray/),50.0_SRK,.FALSE.) .APPROXEQ. 10.0_SRK,'EleHtBelow == 10.0')
      ASSERT(findEleHtBelow((/0.0_SRK,tmprealarray/),62.0_SRK,.FALSE.) .APPROXEQ. 2.0_SRK,'EleHtBelow == 2.0')
      ...
      tmprealarray(9)=20.0_SRK !60.0
      tmprealarray(10)=5.0_SRK  !65.0
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),-11.0_SRK,.TRUE.) .APPROXEQA. -11.0_SRK
      ASSERT(bool,'Out of Lower Bounds')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),101.0_SRK,.TRUE.) .APPROXEQA. 101.0_SRK
      ASSERT(bool,'Out of Upper Bounds')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),-1.0_SRK,.TRUE.) .APPROXEQA. 9.0_SRK
      ASSERT(bool,'Lower Bound == 9.0')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),1.0_SRK,.TRUE.) .APPROXEQA. 1.0_SRK
      ASSERT(bool,'Lower Bound == 1.0')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),3.0_SRK,.TRUE.) .APPROXEQA. 1.0_SRK
      ASSERT(bool,'Lower Bound == 1.0')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),8.0_SRK,.TRUE.) .APPROXEQA. 2.0_SRK
      ASSERT(bool,'Lower Bound == 2.0')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),12.0_SRK,.TRUE.) .APPROXEQA. 2.0_SRK
      ASSERT(bool,'Lower Bound == 2.0')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),18.0_SRK,.TRUE.) .APPROXEQA. 3.0_SRK
      ASSERT(bool,'Lower Bound == 3.0')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),30.0_SRK,.TRUE.) .APPROXEQA. 10.0_SRK
      ASSERT(bool,'Lower Bound == 10.0')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),50.0_SRK,.TRUE.) .APPROXEQA. 10.0_SRK
      ASSERT(bool,'Lower Bound == 10.0')
      bool=findEleHtBelow((/-10.0_SRK,tmprealarray(2:10)/),62.0_SRK,.TRUE.) .APPROXEQA. 2.0_SRK
      ASSERT(bool,'Lower Bound == 2.0')
