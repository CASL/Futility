...
SUBROUTINE test1DReals()
  ...
  COMPONENT_TEST('applyTol 1-D Array')
  ...
  tmprealarray(8)=2.554_SRK
  tmprealarray(9)=2.661_SRK
  tmprealarray(10)=10.0_SRK/3.0_SRK
  CALL applyTol(tmprealarray,0.01_SRK)

  ASSERT_APPROXEQA(tmprealarray(1) ,3.3400_SRK,'%mesh(1)')
  ASSERT_APPROXEQA(tmprealarray(2) ,2.5600_SRK,'%mesh(2)')
  ASSERT_APPROXEQA(tmprealarray(3) ,4.0000_SRK,'%mesh(3)')
  ASSERT_APPROXEQA(tmprealarray(4) ,2.4400_SRK,'%mesh(4)')
  ASSERT_APPROXEQA(tmprealarray(5) ,3.3300_SRK,'%mesh(5)')
  ASSERT_APPROXEQA(tmprealarray(6) ,2.3300_SRK,'%mesh(6)')
  ASSERT_APPROXEQA(tmprealarray(7) ,3.2000_SRK,'%mesh(7)')
  ASSERT_APPROXEQA(tmprealarray(8) ,2.5500_SRK,'%mesh(8)')
  ASSERT_APPROXEQA(tmprealarray(9) ,2.6700_SRK,'%mesh(9)')
  ASSERT_APPROXEQA(tmprealarray(10),3.3300_SRK,'%mesh(10)')
  ...
  tmprealarray(9)=2.661_SRK
  tmprealarray(10)=10.0_SRK/3.0_SRK
  CALL applyTol(tmprealarray,0.001_SRK)

  ASSERT_APPROXEQA(tmprealarray(1) ,3.3350_SRK,'%mesh(1)')
  ASSERT_APPROXEQA(tmprealarray(2) ,2.5550_SRK,'%mesh(2)')
  ASSERT_APPROXEQA(tmprealarray(3) ,4.0050_SRK,'%mesh(3)')
  ASSERT_APPROXEQA(tmprealarray(4) ,2.4440_SRK,'%mesh(4)')
  ASSERT_APPROXEQA(tmprealarray(5) ,3.3330_SRK,'%mesh(5)')
  ASSERT_APPROXEQA(tmprealarray(6) ,2.3330_SRK,'%mesh(6)')
  ASSERT_APPROXEQA(tmprealarray(7) ,3.2000_SRK,'%mesh(7)')
  ASSERT_APPROXEQA(tmprealarray(8) ,2.5540_SRK,'%mesh(8)')
  ASSERT_APPROXEQA(tmprealarray(9) ,2.6610_SRK,'%mesh(9)')
  ASSERT_APPROXEQA(tmprealarray(10),3.3340_SRK,'%mesh(10)')
  ...
  tmprealarray(9)=2.661_SRK
  tmprealarray(10)=10.0_SRK/3.0_SRK
  CALL applyTol(tmprealarray,0.0001_SRK)

  ASSERT_APPROXEQA(tmprealarray(1) ,3.3351_SRK,'%mesh(1)')
  ASSERT_APPROXEQA(tmprealarray(2) ,2.5551_SRK,'%mesh(2)')
  ASSERT_APPROXEQA(tmprealarray(3) ,4.0051_SRK,'%mesh(3)')
  ASSERT_APPROXEQA(tmprealarray(4) ,2.4444_SRK,'%mesh(4)')
  ASSERT_APPROXEQA(tmprealarray(5) ,3.3330_SRK,'%mesh(5)')
  ASSERT_APPROXEQA(tmprealarray(6) ,2.3330_SRK,'%mesh(6)')
  ASSERT_APPROXEQA(tmprealarray(7) ,3.2000_SRK,'%mesh(7)')
  ASSERT_APPROXEQA(tmprealarray(8) ,2.5540_SRK,'%mesh(8)')
  ASSERT_APPROXEQA(tmprealarray(9) ,2.6610_SRK,'%mesh(9)')
  ASSERT_APPROXEQA(tmprealarray(10),3.3333_SRK,'%mesh(10)')
