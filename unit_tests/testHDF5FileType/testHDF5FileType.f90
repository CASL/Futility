...
!-------------------------------------------------------------------------------
    SUBROUTINE testHDF5FileTypeErrorCheck()
      ...
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==6,'%write_d5 %isinit check')
      CALL h5%fwrite('groupR->memD6',refD6,SHAPE(refD6))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==7,'%write_d6 %isinit check')
      CALL h5%fwrite('groupR->memD7',refD7,SHAPE(refD7))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==8,'%write_d7 %isinit check')
      CALL h5%fwrite('groupR->memS0',refS0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==9,'%write_s0 %isinit check')
      CALL h5%fwrite('groupR->memS1',refS1,SHAPE(refS1))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==10,'%write_s1 %isinit check')
      CALL h5%fwrite('groupR->memS2',refS2,SHAPE(refS2))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==11,'%write_s2 %isinit check')
      CALL h5%fwrite('groupR->memS3',refS3,SHAPE(refS3))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==12,'%write_s3 %isinit check')
      CALL h5%fwrite('groupR->memS4',refS4,SHAPE(refS4))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==13,'%write_s4 %isinit check')
      CALL h5%fwrite('groupR->memS5',refS5,SHAPE(refS5))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==14,'%write_s5 %isinit check')
      CALL h5%fwrite('groupR->memS6',refS6,SHAPE(refS6))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==15,'%write_s6 %isinit check')
      CALL h5%fwrite('groupR->memS7',refS7,SHAPE(refS7))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==16,'%write_s7 %isinit check')
      CALL h5%fwrite('groupI->memL0',refL0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==17,'%write_l0 %isinit check')
      CALL h5%fwrite('groupI->memL1',refL1,SHAPE(refL1))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==18,'%write_l1 %isinit check')
      CALL h5%fwrite('groupI->memL2',refL2,SHAPE(refL2))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==19,'%write_l2 %isinit check')
      CALL h5%fwrite('groupI->memL3',refL3,SHAPE(refL3))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==20,'%write_l3 %isinit check')
      CALL h5%fwrite('groupI->memL4',refL4,SHAPE(refL4))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==21,'%write_l4 %isinit check')
      CALL h5%fwrite('groupI->memL5',refL5,SHAPE(refL5))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==22,'%write_l5 %isinit check')
      CALL h5%fwrite('groupI->memL6',refL6,SHAPE(refL6))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==23,'%write_l6 %isinit check')
      CALL h5%fwrite('groupI->memL7',refL7,SHAPE(refL7))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==24,'%write_l7 %isinit check')
      CALL h5%fwrite('groupI->memN0',refN0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==25,'%write_n0 %isinit check')
      CALL h5%fwrite('groupI->memN1',refN1,SHAPE(refN1))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==26,'%write_n1 %isinit check')
      CALL h5%fwrite('groupI->memN2',refN2,SHAPE(refN2))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==27,'%write_n2 %isinit check')
      CALL h5%fwrite('groupI->memN3',refN3,SHAPE(refN3))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==28,'%write_n3 %isinit check')
      CALL h5%fwrite('groupI->memN4',refN4,SHAPE(refN4))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==29,'%write_n4 %isinit check')
      CALL h5%fwrite('groupI->memN5',refN5,SHAPE(refN5))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==30,'%write_n5 %isinit check')
      CALL h5%fwrite('groupI->memN6',refN6,SHAPE(refN6))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==31,'%write_n6 %isinit check')
      CALL h5%fwrite('groupI->memN7',refN7,SHAPE(refN7))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==32,'%write_n7 %isinit check')
      CALL h5%fwrite('groupB->memB0',refB0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==33,'%write_b0 %isinit check')
      CALL h5%fwrite('groupB->memB1',refB1,SHAPE(refB1))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==34,'%write_b1 %isinit check')
      CALL h5%fwrite('groupB->memB2',refB2,SHAPE(refB2))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==35,'%write_b2 %isinit check')
      CALL h5%fwrite('groupB->memB3',refB3,SHAPE(refB3))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==36,'%write_b3 %isinit check')
      CALL h5%fwrite('groupST->memST0',refST0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==37,'%write_st0 %isinit check')
      CALL h5%fwrite('groupST->memST1',refST1,SHAPE(refST1))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==38,'%write_st1 %isinit check')
      CALL h5%fwrite('groupST->memST2',refST2,SHAPE(refST2))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==39,'%write_st2 %isinit check')
      CALL h5%fwrite('groupST->memST3',refST3,SHAPE(refST3))
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==40,'%write_st3 %isinit check')
      ...
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==44,'%read_d0 %isinit check')
      CALL h5%fread('groupR->memD1',refD1)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==45,'%read_d1 %isinit check')
      CALL h5%fread('groupR->memD2',refD2)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==46,'%read_d2 %isinit check')
      CALL h5%fread('groupR->memD3',refD3)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==47,'%read_d3 %isinit check')
      CALL h5%fread('groupR->memD4',refD4)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==48,'%read_d4 %isinit check')
      CALL h5%freadp('groupR->memD4',d4ptr)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==49,'%read_d4 %isinit check')
      CALL h5%fread('groupR->memS0',refS0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==50,'%read_s0 %isinit check')
      CALL h5%fread('groupR->memS1',refS1)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==51,'%read_s1 %isinit check')
      CALL h5%fread('groupR->memS2',refS2)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==52,'%read_s2 %isinit check')
      CALL h5%fread('groupR->memS3',refS3)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==53,'%read_s3 %isinit check')
      CALL h5%fread('groupR->memS4',refS4)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==54,'%read_s4 %isinit check')
      CALL h5%fread('groupI->memL0',refL0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==55,'%read_l0 %isinit check')
      CALL h5%fread('groupI->memL1',refL1)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==56,'%read_l1 %isinit check')
      CALL h5%fread('groupI->memL2',refL2)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==57,'%read_l2 %isinit check')
      CALL h5%fread('groupI->memL3',refL3)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==58,'%read_l3 %isinit check')
      CALL h5%fread('groupI->memN0',refN0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==59,'%read_n0 %isinit check')
      CALL h5%fread('groupI->memN1',refN1)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==60,'%read_n1 %isinit check')
      CALL h5%fread('groupI->memN2',refN2)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==61,'%read_n2 %isinit check')
      CALL h5%fread('groupI->memN3',refN3)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==62,'%read_n3 %isinit check')
      CALL h5%fread('groupB->memB0',refB0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==63,'%read_b0 %isinit check')
      CALL h5%fread('groupB->memB1',refB1)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==64,'%read_b1 %isinit check')
      CALL h5%fread('groupB->memB2',refB2)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==65,'%read_b2 %isinit check')
      CALL h5%fread('groupB->memB3',refB3)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==66,'%read_b3 %isinit check')
      CALL h5%fread('groupST->memST0',refST0)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==67,'%read_st0 %isinit check')
      CALL h5%fread('groupST->memST1',refST1)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==68,'%read_st1 %isinit check')
      CALL h5%fread('groupST->memST2',refST2)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==69,'%read_st2 %isinit check')
      CALL h5%fread('groupST->memST3',refST3)
      ASSERT(h5%e%getCounter(EXCEPTION_ERROR)==70,'%read_st3 %isinit check')
