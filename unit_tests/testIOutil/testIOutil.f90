...
!-------------------------------------------------------------------------------
    SUBROUTINE testIO_Strings()
      ...
      ASSERT_EQ(getFloatFormat(0.0_SRK),1_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-0.0_SRK),2_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(0.1_SRK),1_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-0.1_SRK),2_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(1.1_SRK),1_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-1.1_SRK),2_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(12.1_SRK),2_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-21.1_SRK),3_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(123.1_SRK),3_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-213.1_SRK),4_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(4213.1_SRK),4_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(0.01_SRK),1_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-0.01_SRK),2_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(0.123_SRK),1_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-0.123_SRK),2_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(1.1234_SRK),1_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-1.1342_SRK),2_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(12.12_SRK),2_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-21.12_SRK),3_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(123.12_SRK),3_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(-213.12_SRK),4_SIK,'float_format')
      ASSERT_EQ(getFloatFormat(4213.12_SRK),4_SIK,'float_format')
