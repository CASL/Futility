...
!-------------------------------------------------------------------------------
    SUBROUTINE testIO_Strings()
      ...
      ASSERT_EQ(getFloatFormat(0.0_SRK),0_SIK,'zero')
      ASSERT_EQ(getFloatFormat(-0.0_SRK),0_SIK,'zero')
      ASSERT_EQ(getFloatFormat(0.1_SRK),0_SIK,'zero')
      ...
      ASSERT_EQ(getFloatFormat(0.01_SRK),0_SIK,'zero')
      ASSERT_EQ(getFloatFormat(-0.01_SRK),1_SIK,'zero')
      ASSERT_EQ(getFloatFormat(0.123_SRK),0_SIK,'zero')
