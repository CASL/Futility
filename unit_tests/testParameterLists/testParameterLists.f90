...
!-------------------------------------------------------------------------------
  SUBROUTINE testGetString()
    ...
    tmpbool=(tmpstr == '1.500000E+00; 1.600000E+00')
    ASSERT(tmpbool,'testSSKa1 string')
    CALL testParam%getString('testPL->testSSKa1_2',tmpstr)
    tmpbool=(tmpstr == '1.700000E+00; 1.800000E+00')
    ASSERT(tmpbool,'testSSKa1_2 string')
    ...
    tmpbool=(tmpstr == '11; 21; 12; 22')
    ASSERT(tmpbool,'testSNKa2 string')
    CALL testParam%getString('testPL->testSNKa2_2',tmpstr)
    tmpbool=(tmpstr == '31; 41; 32; 42')
    ASSERT(tmpbool,'testSNKa2_2 string')
    CALL testParam%getString('testPL->testSLKa2',tmpstr)
    tmpbool=(tmpstr == '110; 210; 120; 220')
    ASSERT(tmpbool,'testSLKa2 string')
    CALL testParam%getString('testPL->testSLKa2_2',tmpstr)
    tmpbool=(tmpstr == '310; 410; 320; 420')
    ASSERT(tmpbool,'testSLKa2_2 string')
    ...
    tmpbool=(tmpstr == '111; 211; 121; 221; 112; 212; 122; 222')
    ASSERT(tmpbool,'testSNKa3 string')
    CALL testParam%getString('testPL->testSNKa3_2',tmpstr)
    tmpbool=(tmpstr == '311; 411; 321; 421; 312; 412; 322; 422')
    ASSERT(tmpbool,'testSNKa3_2 string')
    CALL testParam%getString('testPL->testSLKa3',tmpstr)
    tmpbool=(tmpstr == '111; 211; 121; 221; 112; 212; 122; 222')
    ASSERT(tmpbool,'testSLKa3 string')
    CALL testParam%getString('testPL->testSLKa3_2',tmpstr)
    tmpbool=(tmpstr == '311; 411; 321; 421; 312; 412; 322; 422')
    ASSERT(tmpbool,'testSLKa3_2 string')
