...
REGISTER_SUBTEST('%isSection',testIsSection)
...
SUBROUTINE testSet()
  ...
  DO i=1,4
    CALL testGraph%insertVertex(testCoord(:,i))
  ENDDO
  CALL testGraph%defineEdge(testCoord(:,1), &
      testCoord(:,2),c0,SQRT(8.0_SRK))
  CALL testGraph%defineEdge(testCoord(:,2), &
      testCoord(:,3),c0,SQRT(8.0_SRK))
  CALL testGraph%defineEdge(testCoord(:,3), &
      testCoord(:,4),c0,SQRT(8.0_SRK))
  CALL testGraph%defineEdge(testCoord(:,4), &
...
SUBROUTINE testSubtractSubVol()
  ...
  ASSERT(testPoly2%isinit,'%isinit')
  ...
  ASSERT(testPoly3%isinit,'%isinit')
  ...
  CALL testGraph%defineEdge(testCoord(:,4),testCoord(:,1))
  CALL testPoly4%set(testGraph)
  ASSERT(testPoly4%isinit,'%isinit')
  CALL testPolyType%subtractSubVolume(testPoly4)
  ASSERT(ASSOCIATED(testPolyType%subRegions),'%subRegions')
  ASSERT(.NOT.ASSOCIATED(testPolyType%subRegions%nextPoly),'%subRegions%nextPoly')
...
SUBROUTINE testPointInside()
  ...
  c0=(/0.0_SRK,-4.0_SRK/)
  CALL testGraph%defineEdge(testCoord(:,5), &
      testCoord(:,6),c0,SQRT(8.0_SRK))
  c0=(/-1.0_SRK,0.0_SRK/)
  CALL testGraph%defineEdge(testCoord(:,6), &
  ...
  DO i=1,4
    CALL testGraph%insertVertex(testCoord(:,i))
  ENDDO
  CALL testGraph%defineEdge(testCoord(:,1),testCoord(:,2),c0,0.17526000000000000_SRK)
  CALL testGraph%defineEdge(testCoord(:,2),testCoord(:,3),c0,0.17526000000000000_SRK)
  CALL testGraph%defineEdge(testCoord(:,3),testCoord(:,4),c0,0.17526000000000000_SRK)
  CALL testGraph%defineEdge(testCoord(:,4),testCoord(:,1),c0,0.17526000000000000_SRK)
...
SUBROUTINE testPolyInside()
  ...
  ENDDO
  c0=(/0.0_SRK,0.0_SRK/)
  CALL testGraph%defineEdge(testCoord(:,1),testCoord(:,2),c0,0.5_SRK)
  CALL testGraph%defineEdge(testCoord(:,2),testCoord(:,3))
  CALL testGraph%defineEdge(testCoord(:,3),testCoord(:,1))
  CALL testPolyType%set(testGraph)
  ASSERT(testPolyType%isInit,'%isInit')
  ...
  CALL testGraph%defineEdge(testCoord(:,1),testCoord(:,2))
  CALL testGraph%defineEdge(testCoord(:,2),testCoord(:,3))
  CALL testGraph%defineEdge(testCoord(:,3),testCoord(:,4),c0,SQRT(8.0_SRK))
  CALL testGraph%defineEdge(testCoord(:,4),testCoord(:,1))
  CALL testPolyType%set(testGraph)
  ASSERT(testPolyType%isInit,'%isInit')
  ...
  ENDDO
  CALL testGraph%defineEdge(testCoord(:,1),testCoord(:,2))
  CALL testGraph%defineEdge(testCoord(:,2),testCoord(:,3),c0,1.8027756377319946_SRK)
  CALL testGraph%defineEdge(testCoord(:,3),testCoord(:,1))
  CALL testPoly2%set(testGraph)
  ASSERT(testPoly2%isInit,'%isInit')
  ...
  CALL testPoly2%set(testGraph)
  ASSERT(testPoly2%isInit,'%isInit')
  ASSERT(testPolyType%boundsPoly(testPoly2),'smaller square')
  CALL testPolyType%subtractSubVolume(testPoly2)
  ...
  DO i=1,4
    CALL testGraph%insertVertex(testCoord(:,i))
  ENDDO
  CALL testGraph%defineEdge(testCoord(:,1),testCoord(:,2),c0,0.25_SRK)
  CALL testGraph%defineEdge(testCoord(:,2),testCoord(:,3),c0,0.25_SRK)
  CALL testGraph%defineEdge(testCoord(:,3),testCoord(:,4),c0,0.25_SRK)
  CALL testGraph%defineEdge(testCoord(:,4),testCoord(:,1),c0,0.25_SRK)
  CALL testPoly3%set(testGraph)
  ASSERT(testPoly3%isInit,'%isInit')
  ...
  DO i=1,4
    CALL testGraph%insertVertex(testCoord(:,i))
  ENDDO
  CALL testGraph%defineEdge(testCoord(:,1),testCoord(:,2),c0,2.0_SRK)
  CALL testGraph%defineEdge(testCoord(:,2),testCoord(:,3),c0,2.0_SRK)
  CALL testGraph%defineEdge(testCoord(:,3),testCoord(:,4),c0,2.0_SRK)
  CALL testGraph%defineEdge(testCoord(:,4),testCoord(:,1),c0,2.0_SRK)
  CALL testPolyType%set(testGraph)
  CALL testGraph%clear()
  ASSERT(testPolyType%isInit,'%isInit')
  testCoord(:,1)=(/-1.0_SRK,0.0_SRK/)
  ...
  DO i=1,4
    CALL testGraph%insertVertex(testCoord(:,i))
  ENDDO
  CALL testGraph%defineEdge(testCoord(:,1),testCoord(:,2),c0,1.0_SRK)
  CALL testGraph%defineEdge(testCoord(:,2),testCoord(:,3),c0,1.0_SRK)
  CALL testGraph%defineEdge(testCoord(:,3),testCoord(:,4),c0,1.0_SRK)
  CALL testGraph%defineEdge(testCoord(:,4),testCoord(:,1),c0,1.0_SRK)
  CALL testPoly2%set(testGraph)
  CALL testGraph%clear()
  ASSERT(testPoly2%isInit,'%isInit')
  CALL testPolyType%subtractSubVolume(testPoly2)
  ASSERT(ASSOCIATED(testPolyType%subRegions),'set subvolume')
  ...
  DO i=1,4
    CALL testGraph%insertVertex(testCoord(:,i))
  ENDDO
  CALL testGraph%defineEdge(testCoord(:,1),testCoord(:,2),c0,1.5_SRK)
  CALL testGraph%defineEdge(testCoord(:,2),testCoord(:,3),c0,1.5_SRK)
  CALL testGraph%defineEdge(testCoord(:,3),testCoord(:,4),c0,1.5_SRK)
  CALL testGraph%defineEdge(testCoord(:,4),testCoord(:,1),c0,1.5_SRK)
  CALL testPoly3%set(testGraph)
  CALL testGraph%clear()
  ASSERT(testPoly3%isInit,'%isInit')
  CALL testPoly3%subtractSubVolume(testPoly2)
  ASSERT(ASSOCIATED(testPoly3%subRegions),'set subvolume')
...
!Setup test graph - isosceles triangle
  ...
  ASSERT(ALLOCATED(points),'alloc(points)')
  ...
  CALL testPolyType%intersectLine(line,points)
  ASSERT(SIZE(points) == 1,'npoints for one side crossing')
  ...
  CALL testPolyType%intersectLine(line,points)
  ASSERT(ALLOCATED(points),'1 p through vertex')
  ...
  CALL testPolyType%intersectLine(line,points)
  ASSERT(ALLOCATED(points),'2 p through vertex/edge')
  ...
  CALL testPolyType%intersectLine(line,points)
  ASSERT(.NOT.ALLOCATED(points),'npoints for coincident edge')
  ...
  CALL line%set(point1,point2)
  CALL testPolyType%intersectLine(line,points)
  ASSERT(SIZE(points) == 2,'npoints for crossing whole geom')
  ...
  CALL line%set(point1,point2)
  CALL testPolyType%intersectLine(line,points)
  ASSERT(SIZE(points) == 4,'npoints for crossing whole geom')
...
SUBROUTINE testIntersectPoly()
  ...
  ASSERT(testPoly%isinit,'%isinit')
  CALL testPolyType%intersectPoly(testPoly,points)
  ASSERT(SIZE(points) == 6,'SIZE(points)')
...
SUBROUTINE testIsCircle()
  ...
  DO i=1,3
    CALL testGraph%insertVertex(testCoord(:,i))
  ENDDO
  CALL testGraph%defineEdge(testCoord(:,1),testCoord(:,2),c0,5.0_SRK)
  CALL testGraph%defineEdge(testCoord(:,2),testCoord(:,3),c0,5.0_SRK)
  CALL testGraph%defineEdge(testCoord(:,3),testCoord(:,1),c0,5.0_SRK)
  CALL testPolyType%set(testGraph)
  CALL testGraph%clear()
  ASSERT(testPolyType%isinit,'%isinit')
...
SUBROUTINE testIsSector()
  ...
  ASSERT(.NOT.testPolyType%isSector(),'not %isSector, 4-point circle')
  CALL testPolyType%clear()
  ...
  ASSERT(.NOT.testPolyType%isSector(),'not %isSector, quarter circle')
  CALL testPolyType%clear()
  ...
  ASSERT(.NOT.testPolyType%isSector(),'not %isSector, quarter circle w/cutout - one quad')
  CALL testPolyType%clear()
ENDSUBROUTINE testIsSector
!
!-------------------------------------------------------------------------------
SUBROUTINE testIsSection()
  TYPE(PolygonType) :: testPolyType
  INTEGER(SIK) :: i
  REAL(SRK) :: testCoord(2,4),c0(2)
  ...
  ASSERT(testPolyType%isinit,'%isinit')
  ASSERT(testPolyType%isCircle(),'%isCircle, 4-point circle')
  ASSERT(testPolyType%isSection(),'%isSection, 4-point circle')
  CALL testPolyType%clear()
  ...
  ASSERT(testPolyType%isinit,'%isinit')
  ASSERT(.NOT.testPolyType%isCircle(),'not %isCircle, quarter circle')
  ASSERT(testPolyType%isSection(),'%isSection, quarter circle')
  CALL testPolyType%clear()
  ...
  ASSERT(testPolyType%isinit,'%isinit')
  ASSERT(.NOT.testPolyType%isCircle(),'not %isCircle, quarter circle w/cutout')
  ASSERT(.NOT.testPolyType%isSection(),'not %isSection, quarter circle w/cutout')
  CALL testPolyType%clear()
  ...
  ASSERT(testPolyType%isinit,'%isinit')
  ASSERT(.NOT.testPolyType%isCircle(),'not %isCircle, quarter circle w/cutout - one quad')
  ASSERT(.NOT.testPolyType%isSection(),'not %isSection, quarter circle w/cutout - one quad')
  CALL testPolyType%clear()
ENDSUBROUTINE testIsSection
!
!-------------------------------------------------------------------------------
...
SUBROUTINE testPolygonize()
  ...
  ASSERT(testPolyType%isinit,'init polygon from box')
  ...
  ASSERT(testPolyType%isinit,'init polygon from AB box')
  ASSERT(testPolyType%nVert == 4,'%nVert')
  ASSERT(testPolyType%nQuadEdge == 0,'%nQuadEdge')
  ...
  ASSERT(testPolyType%isinit,'init polygon from circle')
  ASSERT(testPolyType%nVert == 4,'%nVert')
  ...
  ASSERT(testPolyType%isinit,'init polygon from cylinder')
  ASSERT(testPolyType%nVert == 4,'%nVert')
  ASSERT(testPolyType%nQuadEdge == 4,'%nQuadEdge')
  bool=(testPolyType%quadEdge(1,1) .APPROXEQA. 1.0_SRK) .AND. &
      (testPolyType%quadEdge(2,1) .APPROXEQA. 1.0_SRK) .AND. &
  ...
  CALL Polygonize(testcircle,testPolyType)
  ASSERT(testPolyType%isinit,'init polygon from arc circle')
...
SUBROUTINE testGenerateGraph
  ...
  ENDDO
  CALL testGraph2%defineEdge(testCoord(:,1), &
      testCoord(:,2),c0,1.0_SRK)
  CALL testGraph2%defineEdge(testCoord(:,2), &
      testCoord(:,3),c0,1.0_SRK)
  CALL testGraph2%defineEdge(testCoord(:,3), &
      testCoord(:,4),c0,1.0_SRK)
  CALL testGraph2%defineEdge(testCoord(:,4), &
      testCoord(:,1),c0,1.0_SRK)
  CALL testPoly2%clear()
