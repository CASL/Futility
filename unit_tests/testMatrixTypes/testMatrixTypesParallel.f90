...
!Test for distributed banded matrices
  ...
  CALL pList%add('MatrixType->m',15)
  CALL pList%add('MatrixType->nnz',9)
  ...
  !test with n<1
  CALL pList%clear()
  CALL pList%add('MatrixType->n',-1)
  CALL pList%add('MatrixType->m',10)
  CALL pList%add('MatrixType->nnz',9)
  CALL pList%add('MatrixType->MPI_COMM_ID',PE_COMM_WORLD)
  CALL pList%validate(pList,optListMat)
  ...
  CALL pList%clear()
  CALL pList%add('MatrixType->n',10)
  CALL pList%add('MatrixType->m',-1)
  CALL pList%add('MatrixType->nnz',3)
  CALL pList%add('MatrixType->MPI_COMM_ID',PE_COMM_WORLD)
  CALL pList%validate(pList,optListMat)
  CALL thisMatrix%init(pList) !expect exception
  bool = .NOT.thisMatrix%isInit
  ...
  CALL pList%add('MatrixType->n',10)
  CALL pList%add('MatrixType->m',15)
  CALL pList%add('MatrixType->nnz',-1)
  CALL pList%add('MatrixType->MPI_COMM_ID',PE_COMM_WORLD)
  CALL pList%validate(pList,optListMat)
  CALL thisMatrix%init(pList) !expect exception
  bool = .NOT.thisMatrix%isInit
  ...
  ![0 2 0 6 0]
  CALL pList%clear()
  CALL pList%add('MatrixType->n',4)
  CALL pList%add('MatrixType->m',5)
  CALL pList%add('MatrixType->nnz',9)
  CALL pList%add('MatrixType->MPI_COMM_ID',PE_COMM_WORLD)
  CALL pList%validate(pList,optListMat)
  CALL thisMatrix%init(pList)
  ...
  CALL pList%add('MatrixType->n',4)
  CALL pList%add('MatrixType->m',5)
  CALL pList%add('MatrixType->nnz',7)
  CALL pList%add('MatrixType->MPI_COMM_ID',PE_COMM_WORLD)
  CALL pList%validate(pList,optListMat)
  CALL thisMatrix%init(pList)
...
SUBROUTINE testPetscMatrix()
  ...
  CALL pList%clear()
  CALL pList%add('MatrixType->n',4)
  CALL pList%add('MatrixType->nLocal',2)
  CALL pList%add('MatrixType->nnz',2)
  CALL pList%add('MatrixType->onz',2)
...
!Test for distributed block banded matrices
  ...
  CALL pList%clear()
  CALL pList%add('MatrixType->n',12)
  CALL pList%add('MatrixType->nnz',9)
  CALl pList%add('MatrixType->blockSize',3)
  CALL pList%add('MatrixType->MPI_COMM_ID',PE_COMM_WORLD)
  ...
  CALL pList%clear()
  CALL pList%add('MatrixType->n',6)
  CALL plist%add('MatrixType->blockSize',2)
  CALL pList%add('MatrixType->nnz',10)
  CALL pList%add('MatrixType->MPI_COMM_ID',PE_COMM_WORLD)
  CALL pList%validate(pList,optListMat)
  CALL thisMatrix%init(pList)
