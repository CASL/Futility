...
!-------------------------------------------------------------------------------
    SUBROUTINE testAPPROXEQ()
      ...
      bool=.NOT.(1.234560_SSK .APPROXEQ. 1.234575_SSK)
      ASSERT(bool, '1.234560_SSK .APPROXEQ. 1.234575_SSK')
      bool=(1.234560_SSK .APPROXEQ. 1.234570_SSK)
      ...
      bool=1.234560e10_SSK .APPROXEQ. 1.234570e10_SSK
      ASSERT(bool, '1.234560e10_SSK .APPROXEQ. 1.234570e10_SSK')
      bool=.NOT.(1.234560e-10_SSK .APPROXEQ. 1.234575e-10_SSK)
      ...
      bool=1.0e20_SSK .APPROXEQ. 0.9999999e20_SSK
      ...
      bool=1.234567890123450e10_SDK .APPROXEQ. 1.234567890123460e10_SDK
      ASSERT(bool, '1.234567890123450e10_SDK .APPROXEQ. 1.234567890123460e10_SDK')
      bool=.NOT.(1.234567890123450e-10_SDK .APPROXEQ. 1.234567890123465e-10_SDK)
      ...
      bool=1.0e20_SDK .APPROXEQ. 0.9999999999999999e20_SDK
...
!-------------------------------------------------------------------------------
    SUBROUTINE testAPPROXEQR()
      ...
      ASSERT(.NOT.bool, '0.0_SSK .APPROXEQR. 1.2345678e-18_SSK')
      bool=0.0_SSK .APPROXEQR. 0.0_SSK
      ASSERT(bool,'0.0_SSK .APPROXEQR. 0.0_SSK')
      ...
      ASSERT(.NOT.bool, '0.0_SDK .APPROXEQR. 1.234567890123450e-18_SDK')
      bool=0.0_SDK .APPROXEQR. 0.0_SDK
      ASSERT(bool,'0.0_SDK .APPROXEQR. 0.0_SDK')
...
!-------------------------------------------------------------------------------
    SUBROUTINE testCharToDouble()
      ...
      CHARACTER(LEN=*),PARAMETER :: d7='13612.59723'
