...
SUBROUTINE testAPPROXEQ()
  ...
  bool=.NOT.(1.0e20_SSK .APPROXEQ. 0.9999999999999999e20_SDK)
  ASSERT(bool, '1.0e20_SSK .APPROXEQ. 0.9999999999999999e20_SDK')
...
SUBROUTINE testAPPROXEQA()
  ...
  ASSERT(bool, '1.234567890123465_SDK .APPROXEQ. 1.234550_SSK')
  bool=.NOT.(1.0e20_SSK .APPROXEQA. 0.9999999999999999e20_SDK)
  ASSERT(bool, '1.0e20_SSK .APPROXEQ. 0.9999999999999999e20_SDK')
  bool=0.0_SSK .APPROXEQA. 0.9999999e-5_SDK
  ASSERT(bool, '0.0_SSK .APPROXEQ. 0.9999999e-5_SDK')

  COMPONENT_TEST('APPROXEQDS')
#ifdef MIXPRECISION
  bool=1.23456789088888_SDK .APPROXEQDS. 1.234567890123465_SDK
  ASSERT(bool, '1.23456789088888_SDK .APPROXEQDS. 1.234567890123465_SDK')
#else
  bool=.NOT.(1.234567890123450_SDK .APPROXEQDS. 1.234567890123465_SDK)
  ASSERT(bool, '1.234567890123450_SDK .APPROXEQDS. 1.234567890123465_SDK')
  bool=1.234567890123450_SDK .APPROXEQDS. 1.234567890123460_SDK
  ASSERT(bool, '1.234567890123450_SDK .APPROXEQDS. 1.234567890123460_SDK')
#endif
  bool=.NOT.(1.234587890123465_SDK .APPROXEQDS. 1.234567890123465_SDK)
  ASSERT(bool, '1.234587890123465_SDK .APPROXEQDS. 1.234567890123465_SDK')
  bool=.NOT.(1.234567890888888e20_SDK .APPROXEQDS. 1.234567890123465e20_SDK)
  ASSERT(bool, '1.234567890888888e20_SDK .APPROXEQDS. 1.234567890123465e20_SDK')
...
SUBROUTINE testAPPROXEQR()
  ...
  bool=1.0e20_SSK .APPROXEQR. 0.9999999999999999e20_SDK
  ASSERT(bool, '1.0e20_SSK .APPROXEQR. 0.9999999999999999e20_SDK')
  bool=1.0e20_SSK .APPROXEQR. 0.9999919999999999e20_SDK
  ASSERT(bool, '1.234567890123465_SDK .APPROXEQR. 1.234550_SSK')
  bool=.NOT.(1.0e20_SSK .APPROXEQR. 0.9999899999999999e20_SDK)
  ASSERT(bool, '1.234567890123465_SDK .APPROXEQR. 1.234550_SSK')

  COMPONENT_TEST('APPROXEQRDS')
#ifdef MIXPRECISION
  bool=1.23456789088888_SDK .APPROXEQRDS. 1.234567890123465_SDK
  ASSERT(bool, '1.23456789088888_SDK .APPROXEQRDS. 1.234567890123465_SDK')
  bool=1.234567890888888e20_SDK .APPROXEQRDS. 1.234567890123465e20_SDK
  ASSERT(bool, '1.234567890888888e20_SDK .APPROXEQRDS. 1.234567890123465e20_SDK')
#else
  bool=.NOT.(1.234567890123450e10_SDK .APPROXEQRDS. 1.234567890123465e10_SDK)
  ASSERT(bool, '1.234567890123450e10_SDK .APPROXEQRDS. 1.234567890123465e10_SDK')
  bool=1.234567890123450e10_SDK .APPROXEQRDS. 1.234567890123460e10_SDK
  ASSERT(bool, '1.234567890123450e10_SDK .APPROXEQRDS. 1.234567890123460e10_SDK')
#endif
  bool=.NOT.(1.234587890123465_SDK .APPROXEQRDS. 1.234567890123465_SDK)
  ASSERT(bool, '1.234587890123465_SDK .APPROXEQRDS. 1.234567890123465_SDK')
