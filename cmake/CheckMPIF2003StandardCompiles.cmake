...
FUNCTION(CHECK_MPI_F2003_STANDARD_COMPILES )
    ...
    IF(TPL_ENABLE_MPI AND NOT DEFINED MPI_F2003_STANDARD_COMPLIANT)
        IF("3.1.3" VERSION_GREATER CMAKE_VERSION)
            MESSAGE(STATUS "Skipping check if MPI is F2003 standard compliant")
...
#
            ...
            CHECK_Fortran_SOURCE_COMPILES(${CHECK_TEST_SOURCE}
                MPI_F2003_STANDARD_COMPILES)
            IF(MPI_F2003_STANDARD_COMPILES)
                GLOBAL_SET(MPI_F2003_STANDARD_COMPLIANT TRUE)
            ELSE()
                GLOBAL_SET(MPI_F2003_STANDARD_COMPLIANT FALSE)
            ENDIF()
