...
ENDIF()
SET(${PROJECT_NAME}_ENABLE_INSTALL_CMAKE_CONFIG_FILES ON
  CACHE BOOL "Set by default in Settings_Common.cmake")
...
IF(DEFINED ${PROJECT_NAME}_TRILINOS_AS_TPL)
  SET(${PROJECT_NAME}_TRILINOS_TPL ON CACHE INTERNAL "")
  SET(TPL_ENABLE_Tpetra     ON CACHE INTERNAL "")
  SET(TPL_ENABLE_MueLu      ON CACHE INTERNAL "")
  SET(TPL_ENABLE_Ifpack2    ON CACHE INTERNAL "")
  SET(TPL_ENABLE_Anasazi    ON CACHE INTERNAL "")
  SET(TPL_ENABLE_Belos      ON CACHE INTERNAL "")
  SET(TPL_ENABLE_CTeuchos   ON CACHE INTERNAL "")
  SET(TPL_ENABLE_ForTeuchos ON CACHE INTERNAL "")
  SET(CMAKE_PREFIX_PATH ${CMAKE_PREFIX_PATH} ${${PROJECT_NAME}_TRILINOS_AS_TPL})
ELSE()
  SET(${PROJECT_NAME}_TRILINOS_TPL OFF CACHE INTERNAL "")
ENDIF()
...
IF(${PROJECT_NAME} STREQUAL "Futility")
  SET(${PROJECT_NAME}_TRIBITS_DIR
     ...
     CACHE PATH "Set in Futility/cmake/Settings_Common.cmake")
ELSE()
  SET(${PROJECT_NAME}_TRIBITS_DIR
...
# Set Design by Contract to default if not DEFINED
IF(NOT DEFINED Futility_ENABLE_DBC)
  IF("${CMAKE_BUILD_TYPE}" STREQUAL "DEBUG")
    SET(Futility_ENABLE_DBC TRUE)
  ELSE()
